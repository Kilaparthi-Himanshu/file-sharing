...
export const FileIdDisplay = ({ fileId }: { fileId: string }) => {
  ...
  return (
    <div className='absolute flex flex-col max-lg:flex-row items-center w-max h-max top-0 p-4 py-0 rounded-xl max-lg:bg-black max-lg:rounded-b-xl max-lg:rounded-t-none max-lg:border max-lg:border-t-0 border-neutral-500 left-1/2 -translate-x-1/2'>
